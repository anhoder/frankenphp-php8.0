...
FrankenPHP совместим с PHP версии 8.0 и выше.

> **Примечание**: При использовании PHP 8.0 Zend Max Execution Timers недоступны, поэтому таймауты (например, `max_execution_time`) будут автоматически отключены. Для полной функциональности рекомендуется PHP 8.1+.
